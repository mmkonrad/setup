...
#scale services
docker-compose -H :4000 scale seatoverviewservice=$1 seatmanagementservice=$1 bookingservice=$1 customermanagementservice=$1 cleanupservice=$1 notificationservice=$1 pricingservice=3 ui=$1
